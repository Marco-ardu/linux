...
static const struct imx283_reg mode_5472x3648_regs[] = {
	{0x3001, 0x10},
	{0x3105, 0x00},
	{0x3107, 0xA2},
	{0x3004, 0x04},
	...
	{0x3006, 0x00},
	{0x3007, 0x00},
	{0x3009, 0x00},  //	[7:0]	SVR[7:0]	00h	According to exposure time	
	{0x300A, 0x00},  //	[7:0]	SVR[15:8]	00h	According to exposure time	
	{0x300B, 0x10},
	{0x300F, 0x90},
	{0x3010, 0x00},
	{0x3011, 0x00},
...
static const struct imx283_reg mode_2732x1538_regs[] = {
	{0x3001, 0x10},
	{0x3105, 0x00},
	{0x3107, 0xA2},
	{0x3004, 0x18},
...
static const struct imx283_mode supported_modes_10bit[] = {
	{
		...
		.reg_list = {
			.num_of_regs = ARRAY_SIZE(mode_5472x3648_regs),
			.regs = mode_5472x3648_regs,
		},
	},
	{
		/* 4.99MPix 50fps readout mode 2 */
		...
		.reg_list = {
			.num_of_regs = ARRAY_SIZE(mode_2732x1538_regs),
			.regs = mode_2732x1538_regs,
		},
	},
};
...
static void imx283_set_default_format(struct imx283 *imx283)
{
	...
	imx283->mode = &supported_modes_10bit[0];
	imx283->fmt_code = MEDIA_BUS_FMT_SBGGR10_1X10;
}
